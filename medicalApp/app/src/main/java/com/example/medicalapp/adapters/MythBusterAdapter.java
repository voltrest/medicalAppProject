...
public class MythBusterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ArrayList<Myth> mMythList;

    private ArrayList<Integer> mColorList;;
    private int mColorIndex;

    public MythBusterAdapter(ArrayList<Myth> mythList, ArrayList<Integer> colorList) {
