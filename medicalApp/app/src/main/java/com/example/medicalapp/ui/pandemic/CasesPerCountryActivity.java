...
public class CasesPerCountryActivity extends AppCompatActivity {
    //UI Elements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cases_per_country);

        mTableLayout = findViewById(R.id.table_kasus_per_country);
    ...
    private void setContent(JSONArray jsonArray){
        try{
            View tableHeader = getLayoutInflater().inflate(R.layout.table_country_header, null, false);
